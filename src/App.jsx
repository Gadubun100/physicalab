...
math: {
  ...
  biology: {
    title: "Biology", icon: "B", color: "#27AE60",
    badge: "Biology Expert",
    lessons: [
      {
        id: "cells", title: "Cell Biology",
        introduction: "The cell is the basic unit of all living things. Every organism is made of cells — from the simplest bacterium with one cell to the human body with 37 trillion. Cells contain all the machinery needed for life: they extract energy from food, make proteins, reproduce, and respond to their environment. Understanding cells is the foundation of all biology.",
        keyConcepts: [
          "All living things are made of cells — the cell is the basic unit of life",
          "Prokaryotic cells (bacteria) have no nucleus — DNA floats freely in the cytoplasm",
          "Eukaryotic cells (plants, animals, fungi) have a membrane-bound nucleus",
          "The cell membrane controls what enters and leaves the cell",
          "Mitochondria produce energy through respiration — the powerhouse of the cell",
        ],
        workedExample: {
          problem: "A cell divides by mitosis every 20 minutes. How many cells will there be after 2 hours starting from 1 cell?",
          steps: [
            "Number of divisions in 2 hours: 120 minutes / 20 minutes = 6 divisions",
            "Each division doubles the number of cells",
            "After 6 divisions: 2^6 = 64 cells",
            "Starting from 1 cell: 1 x 64 = 64 cells",
          ],
          answer: "64 cells after 2 hours"
        },
        equations: "Cells = 2^n  |  n = number of divisions  |  ATP = energy currency",
        controls: [
          { id: "divisions", label: "Cell Divisions", min: 1, max: 6, val: 3, unit: "" },
        ],
        simKey: "cells",
      },
      {
        id: "genetics", title: "Genetics & DNA",
        introduction: "DNA is the molecule of heredity — it carries the instructions for building and operating every living thing. Genes are sections of DNA that code for specific proteins. When cells divide, DNA is copied exactly so every daughter cell has the same genetic information. Mutations — changes in DNA — drive evolution and can cause disease.",
        keyConcepts: [
          "DNA is a double helix made of four bases: Adenine, Thymine, Guanine, Cytosine",
        ...
        workedExample: {
          problem: "Two heterozygous tall plants (Tt) are crossed. What fraction of offspring will be short (tt)?",
          steps: [
            "Set up Punnett square: T and t from each parent",
            "Cross: Tt x Tt gives TT, Tt, Tt, tt",
            "Results: 1 TT : 2 Tt : 1 tt",
            "Short plants (tt) = 1 out of 4 = 25%",
          ],
          answer: "25% of offspring will be short"
        },
        equations: "DNA: A-T, G-C  |  P(tt) = 0.25 for Tt x Tt  |  Phenotype ratio 3:1",
        controls: [
          { id: "generation", label: "Generation", min: 1, max: 5, val: 2, unit: "" },
        ],
        simKey: "genetics",
      },
      {
        id: "evolution", title: "Evolution & Natural Selection",
        introduction: "Evolution is the change in inherited characteristics of populations over generations. Charles Darwin proposed that natural selection drives evolution — organisms with advantageous traits survive and reproduce more, passing those traits to offspring. Over millions of years, this process has produced the enormous diversity of life on Earth.",
        keyConcepts: [
          "Natural selection: individuals with favourable traits survive and reproduce more",
          "Variation exists within populations — individuals differ genetically",
          "Favourable traits are inherited by offspring and spread through the population",
          "Over time, populations change — this is evolution",
          "Speciation occurs when populations become so different they can no longer interbreed",
        ],
        workedExample: {
          problem: "In a population of 100 beetles, 80 are green (camouflaged) and 20 are brown. Birds eat 50% of brown beetles but only 10% of green beetles each generation. What happens to the population over time?",
          steps: [
            "Green beetles surviving: 80 - (80 x 0.1) = 72 green beetles",
            "Brown beetles surviving: 20 - (20 x 0.5) = 10 brown beetles",
            "Proportion green: 72/82 = 88% (was 80%)",
            "Natural selection increases green proportion each generation",
          ],
          answer: "Green beetles increase in proportion — natural selection favours camouflage"
        },
        equations: "Survival = traits x environment  |  Fitness = reproductive success",
        controls: [
          { id: "generations", label: "Generations", min: 1, max: 20, val: 5, unit: "" },
          { id: "selection", label: "Selection Pressure", min: 1, max: 10, val: 5, unit: "" },
        ],
        simKey: "evolution",
      },
      {
        id: "physiology", title: "Human Physiology",
        introduction: "The human body is a collection of organ systems that work together to maintain life. The heart pumps blood, the lungs exchange gases, the nervous system processes information, and the digestive system extracts nutrients. These systems constantly communicate and adjust to keep the body in a stable internal state — a process called homeostasis.",
        keyConcepts: [
          "Homeostasis maintains stable internal conditions despite external changes",
          "The heart pumps blood through pulmonary (lungs) and systemic (body) circuits",
          "Oxygen enters blood in the lungs and is carried by haemoglobin in red blood cells",
          "Neurons transmit electrical signals — nerve impulses travel at up to 120 m/s",
          "The endocrine system uses hormones to regulate growth, metabolism, and reproduction",
        ],
        workedExample: {
          problem: "The heart beats 72 times per minute and pumps 70ml per beat. Calculate cardiac output per minute and per hour.",
          steps: [
            "Cardiac output per minute = heart rate x stroke volume",
            "Per minute: 72 beats/min x 70 ml/beat = 5040 ml/min = 5.04 L/min",
            "Per hour: 5.04 L/min x 60 min = 302.4 L/hour",
            "This means the heart pumps your entire blood volume every minute",
          ],
          answer: "Cardiac output = 5.04 L/min = 302.4 L/hour"
        },
        equations: "CO = HR x SV  |  HR = heart rate  |  SV = stroke volume",
        controls: [
          { id: "heartrate", label: "Heart Rate", min: 40, max: 180, val: 72, unit: " bpm" },
        ],
        simKey: "physiology",
      },
      {
        id: "ecology", title: "Ecology & Ecosystems",
        introduction: "Ecology studies how organisms interact with each other and their environment. Energy flows through ecosystems from producers (plants) to consumers (animals) to decomposers (bacteria and fungi). Only about 10% of energy transfers between trophic levels — which is why food chains rarely have more than 5 links and why large predators are always rare.",
        keyConcepts: [
          "Producers make food from sunlight through photosynthesis",
          "Primary consumers eat producers; secondary consumers eat primary consumers",
          "Only 10% of energy transfers between trophic levels — the rest is lost as heat",
          "Predator-prey relationships create population cycles",
          "Biodiversity increases ecosystem stability and resilience",
        ],
        workedExample: {
          problem: "A meadow ecosystem has 10,000 kJ of energy in producers. How much energy is available to secondary consumers?",
          steps: [
            "Energy at producer level: 10,000 kJ",
            "Energy at primary consumer level (10% transfer): 10,000 x 0.1 = 1,000 kJ",
            "Energy at secondary consumer level (10% transfer): 1,000 x 0.1 = 100 kJ",
            "Only 1% of original energy reaches secondary consumers",
          ],
          answer: "100 kJ available to secondary consumers (1% of original)"
        },
        equations: "Energy transfer = 10%  |  Biomass pyramid  |  dN/dt = rN(1-N/K)",
        controls: [
          { id: "producers", label: "Producer Population", min: 100, max: 1000, val: 500, unit: "" },
          { id: "consumers", label: "Consumer Population", min: 10, max: 200, val: 50, unit: "" },
        ],
        simKey: "ecology",
      },
    ],
...
function SimCanvas({ simKey, controls }) {
  ...
  useEffect(() => {
    ...
    function loop() {
      ...
      else if (simKey === "doubleslit") drawDoubleslit(ctx, W, H, t, controls);
      else if (simKey === "uncertainty2") drawUncertainty2(ctx, W, H, t, controls);
      else if (simKey === "schrodinger") drawSchrodinger(ctx, W, H, t, controls);
